...
class RecordLogic extends Component {
  sound = null;
  state = {
    audioFile: '',
    recording: false,
        ...
        <View style={styles.rowSecondary}>
          ...
          <Button
            ...
            onPress={() => {
              addClickToGlobal({
                ...this.props,
                body: this.props.numClick + 1,
              });
              audioFile && navigation.navigate('effects');
            }}>
            {'Magic'}
          </Button>
        </View>
...
export default connect(mapStateToProps)(RecordLogic);
